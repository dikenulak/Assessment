...
export function InsufficientCreditsAlert() {
  return (
    <div className="rounded-2xl bg-[#1c1c1c] p-4 flex items-center justify-between relative mt-2 mb-2">
      <button className="absolute top-2 right-2 text-[#555] hover:text-[#888] transition-colors rounded-full bg-[#111] p-0.5">
...
export function ServerBusyAlert() {
  return (
    <div className="rounded-xl bg-[#381a1a] p-3.5 mt-2 mb-2">
      ...
      <div className="text-[#aaa] text-[13px] pl-[26px]">
        ...
        <button className="text-[#aaa] underline hover:text-white transition-colors">
          Retry
        </button>
      </div>
    </div>
...
export function InvalidPromptAlert() {
  return (
    <div className="rounded-2xl p-3 flex gap-3.5 group relative hover:bg-white/5 transition-colors">
